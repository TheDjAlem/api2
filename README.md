...
- 🎯 Entry points to execute your program using `python -m <api2>` or `$ api2` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/TheDjAlem/api2/branch/main/graph/badge.svg?token=api2_token_here)](https://codecov.io/gh/TheDjAlem/api2)
[![CI](https://github.com/TheDjAlem/api2/actions/workflows/main.yml/badge.svg)](https://github.com/TheDjAlem/api2/actions/workflows/main.yml)

Awesome api2 created by TheDjAlem

## Install

from source
```bash
git clone https://github.com/TheDjAlem/api2 api2
cd api2
make install
```
...
```bash
❯ api2 --help
Usage: api2 [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ api2 create-user --help
Usage: api2 create-user [OPTIONS] USERNAME PASSWORD
...
```bash
api2 create-user admin admin --superuser
```
...
Run with `api2 run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `api2 create-user`.
...
-----------------------------------------------------
api2/__init__.py              4      0   100%
api2/app.py                  16      1    94%
api2/cli.py                  21      0   100%
api2/config.py                5      0   100%
api2/db.py                   10      0   100%
api2/models/__init__.py       0      0   100%
api2/models/content.py       47      1    98%
api2/routes/__init__.py      11      0   100%
api2/routes/content.py       52     25    52%
api2/routes/security.py      15      1    93%
api2/routes/user.py          52     26    50%
api2/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in api2/default.toml.
